...
import { Clock, Gradient, Image, ImageInvert, ImageLong } from "@/components/content";
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
            ...
            <div
              ...
              style={{
                ...
                fontWeight: 700,
                lineHeight: '42px',
                background: 'linear-gradient(to bottom, #000c55 0%, #3168aa 100%)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                textShadow: '0 -1px 0 rgba(0,12,85,0.8), 0 1px 1px rgba(106,182,255,0.5)',
              }}
            >
              Fresh Morning
              <br />Prepared
